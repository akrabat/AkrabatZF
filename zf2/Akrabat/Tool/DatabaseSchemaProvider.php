    ...
    extends \Zend\Tool\Project\Provider\AbstractProvider
{
    ...
    public function createMigration($migrationName){
        require_once 'Zend/CodeGenerator/Php/PhpClass.php';
        require_once 'Zend/CodeGenerator/Php/PhpDocBlock.php';
        require_once 'Zend/CodeGenerator/Php/Docblock/Tag/ReturnTag.php';
        $response = $this->_registry->getResponse();
        $methods = array( 
            array(
                'name' => 'up',
                'body'       => PHP_EOL,
                'docblock'   => new Zend\CodeGenerator\Php\PhpDocblock(array(
                    'shortDescription' => 'The migration forward',
                    'tags'             => array(
                        new Zend\CodeGenerator\Php\Docblock\Tag\ReturnTag(array(
                            'datatype'  => 'void',
                        )),
                    ),
                )),
        ...
        $cg = new Zend\CodeGenerator\Php\PhpClass();
        $docblock = new Zend\CodeGenerator\Php\PhpDocblock(array(
